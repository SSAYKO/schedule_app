...
class MainWindow(QMainWindow):
    ...
    def create_schedule(self):
        ...
        for subject in self.schedule.subjects:
            print(f"La materia es: {subject.name} con grupo {subject.group.id} en horario {subject.group.schedule_date1_input} {subject.group.schedule1_hour1_date}-{subject.group.schedule1_hour2_date}, {subject.group.schedule_date2_input} {subject.group.schedule2_hour1_date}-{subject.group.schedule2_hour2_date}")
    ...
    def save_group(self):
        ...
        try:
            ...
            print(f"FECHA1 {schedule1_date} HORA1 {schedule1_hour1_date} HORA2 {schedule1_hour2_date}")
            ...
            print(f"HORA FORMATEADA {schedule1_hour1_time}")
            ...
            group = Group(group_id, schedule1_date, schedule1_hour1_time, schedule1_hour2_time, schedule2_date, schedule2_hour1_time, schedule2_hour2_time)
