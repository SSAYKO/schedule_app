...
class Group:
    def __init__(self, id: int, schedule_date1_input: str, schedule1_hour1_date: datetime, schedule1_hour2_date: datetime, schedule_date2_input: str, schedule2_hour1_date: datetime, schedule2_hour2_date: datetime):
        self.id = id
